...
$assessmentFile = "C:\Users\alyousse\OneDrive - Microsoft\_CopilotAssets\EnvironmentAssessmentAnswers.xlsx"
$ContentFile = "C:\Users\alyousse\OneDrive - Microsoft\_CopilotAssets\EnvironmentAssessmentAnswers.xlsx"
...
Write-Host 'Start FindIndexBeginningWith'
    $i = 0
    ...
    Write-Host 'End FindIndexBeginningWith'
    return false
}
