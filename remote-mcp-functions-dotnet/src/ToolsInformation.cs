...
internal sealed class ToolsInformation
{
    ...
    public const string WhoAmIToolName = "whoami";
    public const string WhoAmIToolDescription =
        "MCP Tool that responds with information about itself.";
    public const string CapacityToolName = "capacity";
    public const string CapacityToolDescription =
        "MCP Tool that provides information about its capacity.";
}
